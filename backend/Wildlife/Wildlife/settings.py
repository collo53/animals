...
env.read_env(BASE_DIR / ".env")  # ✅ Explicit path to .env file
...
if ENVIRONMENT == 'development':
    ...
    DATABASES = {
        'default': dj_database_url.config(default=os.getenv("NEW_DB"))
        
    }
    print("Database settings:")
    print("Engine:", DATABASES['default']['ENGINE'])
    print("Name:", DATABASES['default'].get('NAME', 'Not set'))
